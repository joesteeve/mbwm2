...
typedef enum MBWMAtom 
{
  ...
  MBWM_ATOM_NET_WM_WINDOW_STATE,
  MBWM_ATOM_NET_WM_WINDOW_STATE_FULLSCREEN,
  MBWM_ATOM_NET_WM_WINDOW_STATE_MODAL,
  MBWM_ATOM_NET_WM_WINDOW_STATE_ABOVE,
